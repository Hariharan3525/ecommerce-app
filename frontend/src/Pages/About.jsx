    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          ...
          <p>Our mission at Forever is to empower customers with choice, convenience and confidence. We are dedicated to providing a seamless shopping experience that exceeds expectations, from borrowing and ordering to delivery and beyond.</p>
        </div>
      </div>
