  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        <p onClick={()=>setShowFilter(!showFilter)} className="my-2 text-xl flex items-center cursor-pointer gap-2">FILTERS <img className={`h-3 sm:hidden ${showFilter ? 'rotate-90':''}`} src={assets.dropdown_icon} alt="Dropdown" /></p>
          {/* Category Filter  */}
      ...
      <div className="flex-1">
        <div className="flex justify-between text-base sm:text-2xl mb-4">
          ...
          <select onChange={(e)=>setSortType(e.target.value)} className="border border-gray-400 text-sm px-2">
            <option value="relevant">Shop by: Relevant</option>
